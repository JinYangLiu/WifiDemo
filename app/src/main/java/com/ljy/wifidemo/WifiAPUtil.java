...
public class WifiAPUtil {
    ...
    public static WifiAPUtil getInstance() {
        if (null == sInstance) {
            sInstance = new WifiAPUtil();
        }
        return sInstance;
    }
    ...
    public boolean turnOnWifiAp(String str, String password, WifiSecurityType Type) {
        ...
        Method method = null;
        try {
            method = mWifiManager.getClass().getMethod("setWifiApConfiguration",
                    wcfg.getClass());
        ...
        Boolean rt = null;
        try {
            rt = (Boolean) method.invoke(mWifiManager, wcfg);
